...
<body>
    ...
    <div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
        ...
        <div id="content" class="content">
            <!-- begin page-header -->
            <h1 class="page-header">Input Data Izin Usaha</h1>
            <!-- end page-header -->
            <?php 
                        ...
                        <div class="panel-body">
                            <form action="prosesusaha.php" method="post">
                                ...
                                <div class="form-group row m-b-15">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="nik" class="form-control m-b-5" value="<?= $nik ?>" placeholder="Masukan NIK" />
                                    </div>
                                </div>
                                <div class="form-group row m-b-15">
                                    <label class="col-form-label col-md-3">Nama</label>
                                    <div class="col-md-9">
                                        <input type="text" name="nama" class="form-control m-b-5" value="<?= $nama ?>" placeholder="Masukan Nama" />
                                    </div>
                                </div>
                                <div class="form-group row m-b-15">
